...
import NFTGrid from "../../components_new/NFTGrids/charity_NFTGrid";
...
const CharityBuyPage = () => {
  ...
  const mintNFTWithMetadata = async () => {
    ...
    try {
      ...
      const tx = await contract.mint(ethers.BigNumber.from(paymentAmount));
      ...
      toast({
        title: "Mint Failed",
        description: "Transaction failed. See console for details.",
        status: "error",
        duration: 5000,
        isClosable: true,
      });
